...
var RTable = function (props) {
    ...
    var getThs = function () {
        ...
        return ths.map(function (c) {
            if (c.colSpan !== 0) {
                return react_1.default.createElement("th", { key: c.key, colSpan: c.colSpan, className: c.className || '' }, c.title);
            }
        });
    };
    ...
    var getColGroup = function () {
        ...
        cols = cols.concat(props.columns.map(function (c) {
            return react_1.default.createElement("col", { key: c.key, style: { width: c.width } });
        }));
