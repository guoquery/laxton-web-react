...
var Table = function (props) {
    ...
    var showHeader = react_1.useState(true)[0];
    ...
    var dataSource = props.dataSource, columns = props.columns, restTableProps = __rest(props, ["dataSource", "columns"]);
    ...
    var table = (React.createElement(_1.RTable
    ...
    , { 
        ...
        // {...restProps}
        onRowClick: function (record, index) { return OnRowClick(record, index); }, 
        // components={this.state.components}
        // prefixCls={prefixCls}
        data: props.dataSource, columns: columns }));
    var renderPagination = function () {
        if (props.pagination) {
            return (React.createElement("span", null, "1 -" + props.dataSource.length + " of " + props.pagination.total));
        }
        else {
            return "分页器";
        }
    ...
    return (React.createElement("div", { className: "RTableBox" },
        title,
        table,
        React.createElement("div", { className: "more", onClick: function () { return LoadMore(); } }, "load more"),
